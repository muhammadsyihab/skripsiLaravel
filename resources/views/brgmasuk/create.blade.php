                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="vendor" id="vendor" cols="30" rows="3" placeholder="Suplier"
                                            required>{{ old('vendor') }}</textarea>
                                        @error('vendor')
                                            <div class="text-danger">Tolong isi dengan benar</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control form-control-solid pencarian" id="master_sparepart_id"
                                            ...
                                            <option value="" selected disabled>-- Sparepart / Oli --</option>
                                            @foreach ($spareparts as $sparepart)
                                                <option
                                                    value="{{ $sparepart->id }}"{{ old('master_sparepart_id') == $sparepart->id ? ' selected' : '' }}>
