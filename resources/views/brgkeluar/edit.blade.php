    ...
    <div id="layoutSidenav_content">
        ...
        <main>
            ...
            <div class="container-xl px-4 mt-n10">
                <div class="card">
                    <div class="card-header">Edit Data Barang Keluar</div>
                    <div class="card-body">
                        <form method="post" action="{{ route('brgkeluar.update', $brgkeluarById->id) }}"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" id="tanggal_keluar" name="tanggal_keluar" type="date"
                                            value="{{ $brgkeluarById->tanggal_keluar }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control form-control-solid" id="master_sparepart_id"
                                            ...
                                            @foreach ($spareparts as $sparepart)
                                                <option
                                                    value="{{ $sparepart->id }}"{{ $sparepart->id === $brgkeluarById->master_sparepart_id ? ' selected' : '' }}>
                                                    {{ $sparepart->nama_item }} - {{ $sparepart->unit->no_lambung }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control form-control-solid" id="penerima" name="penerima"
                                            value="{{ $brgkeluarById->penerima }}">
                                            <option value="" selected disabled>Nama</option>
                                            @foreach ($users as $user)
                                                <option
                                                    value="{{ $user->id }}"{{ $user->id === $brgkeluarById->users_id ? ' selected' : '' }}>
                                                    {{ $user->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control form-control-solid" id="tb_tiketing_id"
                                            ...
                                            @foreach ($tickets as $ticket)
                                                <option
                                                    value="{{ $ticket->id }}"{{ $ticket->id === $brgkeluarById->tb_tiketing_id ? ' selected' : '' }}>
                                                    #00{{ $ticket->id }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Jumlah" name="qty_keluar" type="number"
                                            min="0" value="{{ $brgkeluarById->qty_keluar }}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="HM" name="hm_odo" type="number"
                                            min="0" value="{{ $brgkeluarById->hm_odo }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control form-control-solid" id="status" name="status">
                                            ...
                                            <option value="0"{{ $brgkeluarById->status === 0 ? ' selected' : '' }}>
                                                Sudah Diterima</option>
                                            <option value="1"{{ $brgkeluarById->status === 1 ? ' selected' : '' }}>
                                                Dikirim</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Estimasi Pengiriman"
                                            ...
                                            value="{{ $brgkeluarById->estimasi_pengiriman }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        @if ($brgkeluarById->photo)
                                            <img src="{{ asset('storage/spKeluar/' . $brgkeluarById->photo) }}"
                                                class="img-preview img-fluid mb-3 col-sm-5 d-block">
                                        @elseif (empty($brgkeluarById->photo))
                                        ...
                                        <input class="form-control" placeholder="Photo" name="photo" id="photo"
                                            type="file" value="{{ $brgkeluarById->photo }}" onchange="previewImage()">
                                    </div>
                                </div>
                            </div>
                            <!-- END INPUT -->
