        ...
        <main>
            ...
            <div class="container-xl px-4 mt-n10">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form action="{{ route('brgkeluarprb.filter') }}" method="POST">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label for="lokasi">PIT</label>
                                    <select class="form-control form-control-solid" id="lokasi" name="lokasi"
                                        required>
                                        <option value="" selected disabled>Lokasi</option>
                                        @foreach ($allPit as $pit)
                                            <option
                                                value="{{ $pit->id }}"{{ old('lokasi') == $pit->id ? ' selected' : '' }}>
                                                {{ $pit->nama_lokasi }}
                                            </option>
                                        @endforeach
                                    </select>
                ...
                <div class="card card-header-actions">
                    <div class="card-header">
                        <div>
                            Daftar Barang Keluar Pribadi {{ $pitName }}
                        ...
                        <div>
                            ...
                            <div class="modal fade" id="exportPdf" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <form method="post" action="{{ route('brgkeluarprb.pdf') }}"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="lokasi">PIT</label>
                                                        <select class="form-control form-control-solid" id="lokasi"
                            ...
                            <div class="modal fade" id="importExcel" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form method="post" action="{{ route('brgkeluarprb.excel') }}" target="_blank"
                                        ...
                                        <tr>
                                            ...
                                            @if (empty($bk->photo))
                                                <td class="text-center"><img
                                                        ...
                                                        width="60" alt=""></td>
                                            @else
                                                <td><img src="{{ asset('storage/spKeluar/' . $bk->photo) }}"
                                                        height="50"width="50" alt=""></td>
                                            @endif
                                            {{-- <td class="align-middle">
                                                <form method="post" action="{{ route('brgkeluarprb.destroy', $bk->id) }}">
                                                    @csrf
                                                    <a class="btn btn-warning btn-sm" title="Edit"
                                                        href="{{ route('brgkeluarprb.edit', $bk->id) }}">
