        ...
        <main>
            ...
            <div class="container-xl px-4 mt-n10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('update-group', $group->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <!-- INPUT -->
                            <div class="row">
                                <div class="mb-3">
                                    <label for="master_lokasi_id" class="mb-2">Lokasi</label>
                                    <select class="form-control form-control-solid" id="master_lokasi_id"
                                        name="master_lokasi_id">
                                        <option value="" selected disabled>Lokasi</option>
                                        @foreach ($lokasi as $l)
                                            <option value="{{ $l->id }}"
                                                {{ $group->master_lokasi_id === $l->id ? 'Selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        <label for="nama_grup">Nama Group</label>
                                        <input class="form-control" placeholder="nama_grup" name="nama_grup" type="text"
                                            value="{{ $group->nama_grup }}">
                                    </div>
                                </div>
                            </div>
                            <br>
