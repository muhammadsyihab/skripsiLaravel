                    ...
                    <div class="col-lg-12">
                        <div class="card card-header-actions mb-3">
                            <div class="card-header border-bottom">
                                ...
                                <a class="btn btn-outline-green float-right" href="{{ route('buat-jadwal') }}"
                            ...
                            <div class="card-body">
                                <div class="tab-content" id="cardTabContent">
                                    <div class="tab-pane fade show active" id="semua" role="tabpanel"
                                        ...
                                        <h5 class="card-title mb-3">Jadwal Operator Keseluruhan</h5>
                                                    ...
                                                    @foreach ($operator as $op)
                                                        <tr>
                                                            ...
                                                            <td class="flex-inline d-flex">
                                                                ...
                                                                <a href="#exampleModal"
                                                                    data-remote="{{ route('show-jadwal-operator', $op->id) }}"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="exampleModalLabel">Jadwal Masuk dan Keluar Operator
                                                                ...
                                                                <a href="{{ route('edit-jadwal', $op->id) }}"
                                                                    class="btn btn-warning btn-sm" title="Edit"><i
                                                                        data-feather="edit"></i>&nbsp;
                                                                    Edit</a> &nbsp;
                                                                <form action="{{ route('hapus-jadwal', $op->id) }}"
                                                                    method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
