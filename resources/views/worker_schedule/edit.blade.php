                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @endif
                                        <br><br>
										<form method="post" action="{{ route('editjadwalpekerjapost', $detail->id)}}" enctype="multipart/form-data">
										@csrf
                                        <div class="small font-italic text-muted mb-4">Nama : <input class="form-control" value="{{ $name }}" name="detailname" readonly/> </div>
										<div class="small font-italic text-muted mb-4">Jadwal Masuk : <input class="form-control" value="{{ $jadwalmasuk }}" name="jam_kerja_masuk" id="jam_kerja_masuk" type="datetime-local" /> </div>
										<div class="small font-italic text-muted mb-4">Jadwal Keluar : <input class="form-control" value="{{ $jadwalkeluar }}" name="jam_kerja_keluar" id="jam_kerja_keluar" type="datetime-local" /> </div>
										<div class="small font-italic text-muted mb-4">Grup : 
                                            <select class="form-select" aria-label="Default select example" id="grup" name="grup">
                                                <option selected value="{{ $grupid->id }}">{{ $grupid->nama_grup }}</option>
                                                @foreach($grups as $g)
