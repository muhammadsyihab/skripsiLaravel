                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <div class="sidenav-menu-heading">Notification</div>
                            <!-- Sidenav Accordion (Dashboard)-->
                            <a class="nav-link{{ Route::is('notif.index') ? ' active' : '' }}"
                                href="{{ route('notif.index') }}">
                            ...
                            @if (auth()->user()->role == 5 || auth()->user()->role == 0)
                                <!-- Sidenav Menu Heading (Core)-->
                                <div class="sidenav-menu-heading">Production</div>
                                <!-- Sidenav Accordion (Dashboard)-->
                                <a class="nav-link collapsed" href="javascript:void(0);" data-bs-toggle="collapse"
                                    data-bs-target="#collapseFuel" aria-expanded="false"
