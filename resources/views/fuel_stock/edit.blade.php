    ...
    <div id="layoutSidenav_content">
        ...
        <main>
            ...
            <div class="container-xl px-4 mt-n10">
                <div class="card">
                    <div class="card-header">Edit Data Fuel To Stock</div>
                    <div class="card-body">
                        <form action="{{ route('fuel-stock.update', $stockById->id) }}" method="post"
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Tanggal" name="tanggal" type="date"
                                            value="{{ $stockById->tanggal }}" required>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="master_lokasi_id" id="master_lokasi_id" required>
                                            ...
                                            @foreach ($lokasi as $l)
                                                <option value="{{ $l->id }}"{{ $l->id == $stockById->master_lokasi_id ? ' selected' : '' }}>{{ $l->nama_lokasi }}</option>
                                            @endforeach
                                        </select>
                                    </div>                                    
                                </div>
