    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            <div class="container-xl px-4 mt-n10">
                <div class="card">
                    <div class="card-header">Edit Data Sparepart</div>
                    <div class="card-body">
                        <form action="{{ route('sparepart.update', $sparepart->id) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        <label for="jumlah_barang">Nama Item</label>
                                        <input class="form-control" placeholder="Nama Item" name="nama_item" type="text"
                                            value="{{ old('nama_item',  $sparepart->nama_item) }}">
                                        @error('nama_item')
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Part Number" name="part_number"
                                            type="text" value="{{ old('part_number',  $sparepart->part_number) }}">
                                        @error('part_number')
                                            <div class="text-danger">Tolong isi dengan benar</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Satuan" name="uom" type="text"
                                            value="{{ old('uom',  $sparepart->uom) }}" required>
                                        @error('uom')
                                            <div class="text-danger">Tolong isi dengan benar</div>
                                        @enderror
                                    </div>
