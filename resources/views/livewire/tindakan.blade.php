<div>
    ...
    @planner
        <div wire:ignore.self class="modal fade" id="permintaanSparepart" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form wire:submit.prevent="storePermintaan">
                        <div class="modal-body">
                            ...
                            <div class="mb-5" id="selectSpareparts">
                                ...
                                <select class="form-select pencarian" name="inputSparepart" id="inputSparepart"
                                    wire:model.defer="inputSparepart">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" placeholder="Jumlah Sparepart ..." name="jumlah"
                                    id="jumlah" wire:model.defer="jumlah">
                            </div>
                        </div>
    ...
    {{-- pembelian pribadi --}}
    <div wire:ignore.self class="modal fade" id="pribadiLogistik" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form>
                    <div class="modal-body">
                        ...
                        <div class="mb-5" id="userPenerima">
                            ...
                            <select class="form-select pencarian" name="penerimaPribadi" id="penerimaPribadi"
                                wire:model.defer="penerimaPribadi">
                        ...
                        <div class="mb-5" id="userPembeli">
                            ...
                            <select class="form-select pencarian" name="pembeli" id="pembeli"
                                wire:model.defer="pembeli">
                        ...
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Jumlah Sparepart</label>
                            <input type="number" class="form-control" placeholder="Jumlah Sparepart ..." name="qty"
                                id="qty" wire:model.defer="qty">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Part Number ..."
                                name="partNumberPribadi" id="partNumberPribadi" wire:model.defer="partNumberPribadi">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Nama Item</label>
                            <input type="text" class="form-control" placeholder="Nama Item ..." name="namaItem"
                                id="namaItem" wire:model.defer="namaItem">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">UOM</label>
                            <input type="text" class="form-control" placeholder="UOM ..." name="uom"
                                id="uom" wire:model.defer="uom">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" placeholder="Item Price ..." name="itemPrice"
                                id="itemPrice" wire:model.defer="itemPrice">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" placeholder="Tanggal Keluar ..."
                                name="tanggalKeluar" id="tanggalKeluar" wire:model.defer="tanggalKeluar">
                        </div>
                        <div class="mb-3">
                            <label for="exampleFormControlTextarea1" class="form-label">Estimasi Pengiriman</label>
                            <input type="number" class="form-control" placeholder="Estimasi Pengiriman ..."
                                name="estimasi" id="estimasi" wire:model.defer="estimasi">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary" wire:click.prevent="storePribadi()"
                            id="btnPribadi">Buat Pembelian Pribadi</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    @planner
        {{-- tutup ticket --}}
        <div wire:ignore.self class="modal fade" id="tutupTicket" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer"><button class="btn btn-secondary" type="button"
                        ...
                        <button class="btn btn-danger" type="submit" wire:click.prevent="tutupTicket()">Ya, Tutup
                            Pengaduan</button>
                    </div>
                </div>
            </div>
