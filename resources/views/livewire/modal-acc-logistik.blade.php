                                        ...
                                        <td class="align-middle">
                                            @if ($sparepart->status == 0)
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <form>
                                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#setujuPermintaan" wire:click="sendToModal({{ $sparepart->id }})">
                                                            Disetujui
                                                        </button>
...
@livewire('modal-persetujuan', ['pengaduanId' => $pengaduanId])
