    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            <div class="container-xl px-4 mt-n10">
                <div class="card">
                    <div class="card-header">Tambah Jadwal Mekanik</div>
                    <div class="card-body">
                        ...
                        @endif
                        <form method="post" action="{{ route('jadwal-mekanik') }}" enctype="multipart/form-data">
                            @csrf
                            <!-- INPUT -->
                            <div class="row mb-4">
                                <div class="mb-3">
                            ...
                            {{-- <div class="row mb-4">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <select name="master_unit_id" id="master_unit_id" class="form-control units" required>
