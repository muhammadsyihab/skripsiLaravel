                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="fuel_to_stock_id" id="fuel_to_stock_id"
                                            ...
                                            @foreach ($stocks as $stock)
                                                <option
                                                    value="{{ $stock->id }}"{{ $stock->id === $suplierById->oli_stock_id ? ' selected' : '' }}>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="QTY Masuk" name="qty_masuk"
                                            type="number" value="{{ $suplierById->qty_masuk }}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Status"
                                            name="status" type="text" value="{{ $suplierById->status }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Purchasing Order" name="purchasing_order"
                                            type="text" value="{{ $suplierById->purchasing_order }}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                                        <label for="vendor">Vendor</label>
                                        <input class="form-control" placeholder="Vendor" name="vendor" type="text" value="{{ $suplierById->vendor }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="notes" rows="3" name="notes">{{ $suplierById->notes }}</textarea>
                                  </div>
                            </div>
                            <!-- End INPUT -->
                            <br>
