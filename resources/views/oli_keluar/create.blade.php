                                        ...
                                        <select name="fuel_to_stock_id" id="fuel_to_stock_id"
                                            ...
                                            @foreach ($stocks as $stock)
                                                <option value="{{ $stock->id }}">
                                                    {{ now()->parse($stock->tanggal)->format('j F Y') }} ({{ $stock->storage->nama_storage }}) {{ $stock->storage->lokasi->nama_lokasi }} 
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                        ...
                                        <select name="daily_unit_id" id="daily_unit_id"
                                            ...
                                            @foreach ($dailys as $daily)
                                                <option value="{{ $daily->tanggal }}">
                                                    {{ now()->parse($daily->tanggal)->format('j F Y') }} ({{ $daily->unit->no_lambung }}) {{ $daily->unit->lokasi->nama_lokasi }} <i>{{ $daily->user->name }}</i>
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
