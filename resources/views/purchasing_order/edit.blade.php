    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            <div class="container-xl px-4 mt-n10">
                <div class="card">
                    <div class="card-header">Edit Purchasing Order</div>
                    <div class="card-body">
                        <form method="post" action="{{ route('purchasing.order.update', $brgmasukById->id) }}"
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Item Price" name="item_price"
                                            type="number" min="0" value="{{ old('item_price', $brgmasukById->item_price) }}">
                                        @error('item_price')
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Quantity Masuk" name="qty_masuk"
                                            type="number" min="0" value="{{ old('qty_masuk', $brgmasukById->qty_masuk) }}">
                                        @error('qty_masuk')
                                            <div class="text-danger">Tolong isi dengan benar</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Tanggal Masuk" name="tanggal_masuk"
                                            type="date" value="{{ old('tanggal_masuk', $brgmasukById->tanggal_masuk) }}">
                                        @error('tanggal_masuk')
                                            <div class="text-danger">Tolong isi dengan benar</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Nomer Purchasing Order" name="nomor_po"
                                            type="text" value="{{ old('nomor_po', $brgmasukById->nomor_po) }}">
                                        @error('nomor_po')
                                            <div class="text-danger">Tolong isi dengan benar</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Tanggal Masuk" name="penerima"
                                            type="text" value="{{ old('penerima', $brgmasukById->penerima) }}">
                                        @error('penerima')
                                            <div class="text-danger">Tolong isi dengan benar</div>
                                        @enderror
                                    </div>
