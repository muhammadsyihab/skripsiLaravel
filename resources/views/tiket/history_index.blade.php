        ...
        <main>
            ...
            <div class="container-xl px-4 mt-n10">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form action="{{ route('historyTiketFilter') }}" method="POST">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-md-6">
                        ...
                        <div class="small">
                            ...
                            <div class="modal fade" id="exportPdf" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <form method="post" action="{{ route('ticketHistory.pdf') }}" enctype="multipart/form-data"
                                        target="_blank">
                            ...
                            <div class="modal fade" id="importExcel" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form method="post" action="{{ route('ticketHistory.excel') }}" target="_blank"
