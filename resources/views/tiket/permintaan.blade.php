        ...
        <main>
            ...
            <div class="container-xl px-4 mt-n10">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form action="{{ route('reqTiketFilter') }}" method="POST">
                            @csrf
                            <div class="row mb-3">
                                <div class="col-md-6">
                ...
                <div class="card card-header-actions">
                    <div class="card-header">
                        <div>
                            Daftar Permintaan Laporan Kerusakan
                            @planner
                        ...
                        <div>
                            ...
                            <div class="modal fade" id="exportPdf" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <form method="post" action="{{ route('req-ticket.pdf') }}"
                            ...
                            <div class="modal fade" id="importExcel" tabindex="-1" role="dialog"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form method="post" action="{{ route('req-ticket.excel') }}" target="_blank"
                                ...
                                <tbody>
                                    @foreach ($tiket as $t)
                                        <tr>
                                            ...
                                            @elseif ($t->status_ticket === '10')
                                                <td>Permintaan Ticket</td>
                                            @else
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-success btn-sm"
                                                    href="{{ route('ticket.edit', $t->id) }}"
                                                    onclick="return confirm('Apakah anda yakin ingin menyetujui permintaan?')"><i
                                                        class="fas fa-check"></i>&nbsp;Acc</a>
                                            </td>
                                            {{-- @endplanner --}}
                                        </tr>
                                    @endforeach
